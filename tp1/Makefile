...
SKEL_CPP_FILES = image.cpp image_io.cpp histogram.cpp tools.cpp
SKEL_HH_FILES  = image.hh histogram.hh image_io.hh tools.hh

CPP_FILES =  $(SKEL_CPP_FILES)
H_FILES =  $(SKEL_HH_FILES)
OBJ_FILES = $(CPP_FILES:.cpp=.o)

CXX_FLAGS += -Wall -Wextra -g -std=c++11 -O3
CXX_FLAGS += -lm
